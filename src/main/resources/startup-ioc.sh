...
nohup java -Xms4096m -Xmx8192m -Xmn1024m -server -XX:+HeapDumpOnOutOfMemoryError \
	...
	--spring.datasource.primary.url="jdbc:mysql://59.195.12.154:3306/datamover?useUnicode=true&characterEncoding=UTF-8&allowMultiQueries=true&zeroDateTimeBehavior=convertToNull&useSSL=false&autoReconnect=true" \
	--spring.datasource.primary.username=root \
	--spring.datasource.primary.password=Audaque@2019 \
