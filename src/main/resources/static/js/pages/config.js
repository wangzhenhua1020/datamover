		...
		$('#parseVarBtn').click(function() {
			var editor = $('#srcSqlCont').data('editor'),
				...
				innerVars = ['CONFIG_ID', 'CONFIG_NAME', 'CONFIG_REMARK', 'CONFIG_INST_ID', 'SRC_DS_NAME', 'SRC_DS_USER', 'DEST_DS_NAME',
					...
					'DATETIME_TODAY_START_TIME', 'DATETIME_TODAY_END_TIME', 'DATETIME_YESTERDAY_START_TIME', 'DATETIME_YESTERDAY_END_TIME',
					...
					'DATETIME_CURRENT_MINUTE_START_TIME', 'DATETIME_CURRENT_MINUTE_END_TIME', 'DATETIME_LAST_MINUTE_START_TIME', 'DATETIME_LAST_MINUTE_END_TIME'];
